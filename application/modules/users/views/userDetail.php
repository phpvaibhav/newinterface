								...
								<div class="col-sm-12">
									...
									<div class="row">
										...
										<div class="col-sm-3 profile-pic">
											<img src="<?php echo $backend_assets;?>img/avatars/sunny-big.png" alt="demo user">
										...
										<div class="tab-content padding-top-10">
											...
											<div class="tab-pane fade" id="a2">
												...
												<div class="user" title="email@company.com">
													<img src="<?php echo $backend_assets;?>img/avatars/female.png" alt="demo user"><a href="javascript:void(0);">Jenn Wilson</a>
													<div class="email">
														travis@company.com
													</div>
												</div>
												<div class="user" title="email@company.com">
													<img src="<?php echo $backend_assets;?>img/avatars/male.png" alt="demo user"><a href="javascript:void(0);">Marshall Hitt</a>
													<div class="email">
														marshall@company.com
													</div>
												</div>
												<div class="user" title="email@company.com">
													<img src="<?php echo $backend_assets;?>img/avatars/male.png" alt="demo user"><a href="javascript:void(0);">Joe Cadena</a>
													<div class="email">
														joe@company.com
													</div>
												</div>
												<div class="user" title="email@company.com">
													<img src="<?php echo $backend_assets;?>img/avatars/male.png" alt="demo user"><a href="javascript:void(0);">Mike McBride</a>
													<div class="email">
														mike@company.com
													</div>
												</div>
												<div class="user" title="email@company.com">
													<img src="<?php echo $backend_assets;?>img/avatars/male.png" alt="demo user"><a href="javascript:void(0);">Travis Wilson</a>
													<div class="email">
														travis@company.com
													</div>
												</div>
